    ...
    <xsl:template match="/">
        <html lang="en-US">
            <head>
                ...
                <meta name="apple-mobile-web-app-title" content="Syriac Liturgy - Anaphoras"></meta>
                                        <link rel="profile" href="http://gmpg.org/xfn/11"></link>
                                            <title><xsl:value-of select="concat('Syriac Liturgy - Anaphoras - ',tei:TEI/tei:teiHeader/tei:fileDesc/tei:titleStmt/tei:title[1]/text())"/></title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 content-area" id="primary">
                                    <main class="site-main" id="main">
                                        ...
                                        <h5 class="content-block-title"><span class="separator-title">Anaphoras</span></h5>
                                    ...
                                    <main class="site-main" id="main">
                                        <article style="background-color: white; padding:20pt;">
                                            <header class="entry-header">
                                                <h1 class="entry-title text-center"><xsl:value-of select="tei:TEI/tei:teiHeader/tei:fileDesc/tei:titleStmt/tei:title[1]/text()"/></h1>
                                            </header><!-- .entry-header -->
                                            <div class="entry-content">
                                                ...
                                                <xsl:element name="h3">
                                                    <xsl:attribute name="class" select="'text-center'"/>
                                                    <xsl:value-of select="tei:TEI/tei:teiHeader/tei:fileDesc/tei:titleStmt/tei:respStmt[1]/tei:persName/text()"/>
                                                </xsl:element>
                                                <xsl:element name="h5">
                                                    <xsl:attribute name="class" select="'text-center'"/>
                                                ...
                                                <xsl:element name="p">
                                                    ...
                                                    <xsl:value-of select="concat(tei:TEI/tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:msDesc/tei:msIdentifier/tei:settlement/text(),' - ',tei:TEI/tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:msDesc/tei:msIdentifier/tei:idno/text())"/>
                                                </xsl:element>
                                                <xsl:element name="p">
                                                    <xsl:attribute name="style" select="'margin-left: 20pt;'"/>
                                                    <xsl:value-of select="tei:TEI/tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:msDesc/tei:msContents/tei:msItem/tei:p/text()"/>
                                                </xsl:element>
                                                <xsl:element name="p">
                                                    <xsl:attribute name="style" select="'margin-left: 20pt;'"/>
