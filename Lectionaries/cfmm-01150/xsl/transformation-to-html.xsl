    ...
    <xsl:template match="/">
        <html lang="en-US">
            <head>
                ...
                <meta name="apple-mobile-web-app-title" content="Syriac Liturgy - Lectionaries"></meta>
                                        <link rel="profile" href="http://gmpg.org/xfn/11"></link>
                <title><xsl:value-of select="concat('Syriac Liturgy - Lectionaries - ',tei:TEI/tei:teiHeader/tei:fileDesc/tei:titleStmt/tei:title[1]/text())"/></title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 content-area" id="primary">
                                    <main class="site-main" id="main">
                                        ...
                                        <h5 class="content-block-title"><span class="separator-title">Lectionaries</span></h5>
